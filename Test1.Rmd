...
```{r, echo=FALSE,fig.width=12, fig.cap= c("Fig. 1 Total de especies reportadas por categoría en los Parques Naturales.", "Fig. 2 Ubicación y área ocupada por los Parques Naturales.", "Fig. 3 Localización y total de especies registradas en los Parques Naturales.", "Fig. 4 Regresrión lineal entre el área de los parques y el total de especies.", "Fig. 5 Regresión lineal entre la ubicación latitudinal de los parques y el total de especies.")}
...
ggplot(parque,aes(x=Longitude,y=Latitude))+geom_point(aes(size=Acres))+
  theme_classic()
